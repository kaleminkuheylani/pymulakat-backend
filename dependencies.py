...
async def get_current_user(request: Request):
    ...
    # HS256 başarısız — Dogrudan Supabase Auth API /auth/v1/user
    # 2026-07-18: Supabase Python SDK v2 get_user(jwt) "invalid claims" hatasi
    # donduruyor. Dogrudan HTTP istegi ile bypass — daha güvenilir.
